...
```{r showSites}
aurnDT <- aurnDT[obsDate > as.Date("2019-01-01")] # for speed
...
```{r wstest, fig.cap = "Availability and level of o3 data over time"}
...
```{r wdtest, fig.cap = "Availability and level of o3 data over time"}
...
f <- paste0(here::here(), "/data/sotonExtract2019_2020.csv")
