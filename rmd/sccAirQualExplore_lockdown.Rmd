...
fixedDT[, site := ifelse(site == "Southampton Centre", "Southampton Centre (via AURN)", site)]
...
addWeekendsDate(p) + scale_x_date(date_breaks = "7 day",
                                  date_labels =  "%a %d %b",
...
f <- paste0(here::here(), "/data/sotonExtract2018_2020_v2.csv")
