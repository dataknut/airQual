...
Southampton City Council collects various forms of air quality data at the sites shown in Table \@ref(tab:showSites). The data is available in raw form from http://southampton.my-air.uk.

Some of these sites feed data to [AURN](https://uk-air.defra.gov.uk/networks/network-info?view=aurn). The data that goes via AURN is [ratifified](https://uk-air.defra.gov.uk/assets/documents/Data_Validation_and_Ratification_Process_Apr_2017.pdf) to check for outliers and instrument/measurement error. AURN data less than six months old has not undergone this process. AURN data is (c) Crown 2020 copyright Defra via https://uk-air.defra.gov.uk, licenced under the [Open Government Licence](http://www.nationalarchives.gov.uk/doc/open-government-licence/version/2/) (OGL).

Latest data updated:

 * http://southampton.my-air.uk last updated at `r lastSCC` (`r round(diffSCC,2)` hours ago)
 * https://uk-air.defra.gov.uk/networks/network-info?view=aurn last updated at `r lastAURN` (`r round(diffAURN,2)` hours ago)
...
Figure \@ref(fig:no2pcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period). In either case we can see that NO2 levels in 2020 were generally _already_ lower than the reference period yet are _not_ consistently lower even during the lockdown period. The effects of covid lockdown are not clear cut...

```{r no2pcDiffcompare, fig.cap="Percentage difference in daily mean Nitrogen Dioxide levels 2020 vs 2017-2019, Southampton"}

compareYearsDiffPlot(no2dt[fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap, myParams$noThresh))
...
Figure \@ref(fig:noxpcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period). IN either case we can see that NO2 levels in 2020 were generally _already_ lower than the reference period yet are _not_ consistently lower even during the lockdown period. The effects of covid lockdown are not clear cut...

```{r noxpcDiffcompare, fig.cap="% difference in daily mean Oxides of Nitrogen levels 2020 vs 2017-2019, Southampton"}
...
Figure \@ref(fig:so2pcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period).

```{r so2pcDiffcompare, fig.cap="% difference in daily mean Sulphour Dioxide levels 2020 vs 2017-2019, Southampton"}
...
Figure \@ref(fig:03pcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period).

```{r o3pcDiffcompare, fig.cap="% difference in daily mean Ozone levels 2020 vs 2017-2019, Southampton"}
...
Figure \@ref(fig:pm10pcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period).

```{r pm10pcDiffcompare, fig.cap="% difference in daily mean PM10 levels 2020 vs 2017-2019, Southampton"}
...
Figure \@ref(fig:pm25pcDiffcompare) shows the % difference between the daily and weekly means for 2020 vs 2017-2019 (reference period).

```{r pm25pcDiffcompare, fig.cap="% difference in daily mean PM2.5 levels 2020 vs 2017-2019, Southampton"}
