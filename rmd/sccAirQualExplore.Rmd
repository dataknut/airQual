...
addLockdownDate <- function(p){
  ...
  p <- p + annotate("rect", xmin = lubridate::as_date("2020-03-24"),
             xmax = lubridate::as_date("2020-05-01"), 
             ymin = yMin, ymax = yMax, 
             alpha = rectAlpha, 
             fill = vLineCol, 
             colour = vLineCol)
...
addLockdownDateTime <- function(p){
  ...
  p <- p + annotate("rect", xmin = lubridate::as_datetime("2020-03-24 00:00:00"),
             xmax = lubridate::as_datetime("2020-05-01 00:00:00"), 
             ymin = yMin, ymax = yMax, 
             alpha = rectAlpha, 
             fill = vLineCol, 
             colour = vLineCol) 
...
The data used here is _not_ cleaned or tested for measurement error. If you want that data you need to go to https://uk-air.defra.gov.uk/data-plot?site_id=SOUT&days=7
