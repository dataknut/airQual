...
```{r no2FromFeb1, fig.cap="Nitrogen Dioxide levels, Southampton (hourly, recent"}
...
```{r so2FromFeb1, fig.cap="Sulphour Dioxide levels, Southampton (hourly, recent"}
...
```{r 03FromFeb1, fig.cap="03 levels, Southampton (hourly, recent"}
