...
However, the durbinWatsonTest test suggests autocorrelation as we would expect. This means the standard errors are likely to be underestimates and so the confidence intervals are too narrow. Effects we think are statistically significant are probably not...
...
Again, the durbinWatsonTest test suggests autocorrelation as we would expect. This means the standard errors are likely to be underestimates and so the confidence intervals are too narrow. Effects we think are statistically significant are probably not...
