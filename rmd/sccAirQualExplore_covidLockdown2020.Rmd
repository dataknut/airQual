...
compareYearsDiffPlot(no2dt[site %like% "via AURN" & fixedDate >= testDate]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
...
compareYearsDiffPlot(noxdt[site %like% "via AURN" & fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
...
compareYearsDiffPlot(so2dt[site %like% "via AURN" & fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
```
...
compareYearsDiffPlot(o3dt[site %like% "via AURN" & fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
...
compareYearsDiffPlot(pm10dt[site %like% "via AURN" & fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
...
compareYearsDiffPlot(pm25dt[site %like% "via AURN" & fixedDate >= myParams$comparePlotCut]) +
    labs(caption = paste0(myParams$lockdownCap, myParams$weekendCap))
