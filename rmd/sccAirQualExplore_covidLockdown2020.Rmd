 ...
 * http://www.hantsair.org.uk/hampshire/asp/Bulletin.asp?la=Southampton last updated at `r lastHA` (``r as.duration(diffHA)` ago);
 * https://uk-air.defra.gov.uk/networks/network-info?view=aurn last updated at `r lastAURN` (`r as.duration(diffAURN)` ago).
