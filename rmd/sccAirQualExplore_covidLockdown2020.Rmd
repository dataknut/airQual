...
addWeekendsDate <- function(p, yMin, yMax){
  ...
  p <- p + annotate("rect", xmin = as.Date("2020-04-25"),
                    ...
                    ymin = yMin, ymax = yMax,
                    alpha = myParams$weAlpha, fill = myParams$weFill)
  p <- p + annotate("rect", xmin = as.Date("2020-05-02"),
...
addWeekendsDateTime <- function(p, yMin, yMax){
  ...
  p <- p + annotate("rect", xmin = lubridate::as_datetime("2020-04-18 00:00:00"),
    ...
    p <- p + annotate("rect", xmin = lubridate::as_datetime("2020-04-25 00:00:00"),
                    ...
                    ymin = yMin, ymax = yMax,
                    alpha = myParams$weAlpha, fill = myParams$weFill)
    p <- p + annotate("rect", xmin = lubridate::as_datetime("2020-05-02 00:00:00"),
    ...
    p <- p + annotate("rect", xmin = lubridate::as_datetime("2020-05-08 00:00:00"),
                    ...
                    ymin = yMin, ymax = yMax,
                    alpha = myParams$weAlpha, fill = myParams$weFill)
  p <- p + annotate("text", x = lubridate::as_datetime("2020-05-08 00:00:00"),
                    y = yMax*myParams$labelPos,
                    label = "VE Day") # VE Day
  return(p)
}
