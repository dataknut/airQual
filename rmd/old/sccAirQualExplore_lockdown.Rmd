...
Table \@ref(tab:showSites) shows the available sites and sources. Note that some of the non-AURN sites appear to [have stopped updating recently](https://github.com/CfSOtago/airQual/issues/1). For a detailed analysis of recent missing data see Section \@ref(annexMissing).
